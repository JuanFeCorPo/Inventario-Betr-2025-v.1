...
<td className="p-4">
  <span className={`inline-block px-3 py-1 text-xs font-semibold rounded-full whitespace-nowrap 
    ${item.estado === 'Disponible' ? 'bg-green-600 text-white' :
      ...
      item.estado === 'Fuera de Servicio' ? 'bg-red-600 text-white' :
